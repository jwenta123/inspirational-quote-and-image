...
const Quotes = (props) => {
	const [ currentQuote, setQuote ] = useState('Click me for inspiration!');
	const [ currentFontType, setFontType ] = useState('Open Sans Condensed');
	...
	let displayedQuote = currentQuote;
